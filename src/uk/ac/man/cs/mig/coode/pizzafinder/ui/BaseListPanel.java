...
public class BaseListPanel extends JPanel implements Selectable {
	...
	public BaseListPanel(final Selectable selectable,
	                               final CoffeeChoiceModel choiceModel2) {
		this.title = "Chosen base:";
