...
public class BasePanel extends JPanel implements Selectable {
	...
	public BasePanel(CoffeeOntology ontology) {
	...
	protected JTree buildTree() throws OWLReasonerException {
		MutableTreeNode rootNode = new DefaultMutableTreeNode("Baze");
		Iterator basesCatIt = ontology.getCoffeeBasesCategories().iterator();
		while(basesCatIt.hasNext()) {
			OWLClass cls = (OWLClass)basesCatIt.next();
	...
	public static void main(String [] args) {
		BasePanel panel = new BasePanel(new CoffeeOntology());
