...
public class ExtrasPanel extends JPanel implements Selectable {
	...
	public ExtrasPanel(CoffeeOntology ontology) {
	...
	protected JTree buildTree() throws OWLReasonerException {
		MutableTreeNode rootNode = new DefaultMutableTreeNode("Dodaci");
		Iterator toppingCatIt = ontology.getCoffeeExtrasCategories().iterator();
	...
	public static void main(String [] args) {
		ExtrasPanel panel = new ExtrasPanel(new CoffeeOntology());
