...
import uk.ac.man.cs.mig.coode.pizzafinder.model.CoffeePreferences;
...
public class AboutPanel extends JPanel {
	...
	public static final String ACK_1 = "Authors: Matthew Horridge, Afsaneh Maleki_Dizaji ";
	...
	protected void setupInformationPanel() {
		...
		gbc.gridy = 1;
		box.add(new JLabel("Ontology location: " + CoffeePreferences.getInstance().getOntologyURL()), gbc);
		gbc.gridy = 2;
	...
	protected class ImagePanel extends JPanel {
		...
		public ImagePanel() {
			try {
				URL url = getClass().getResource("image/CoffeeFinderAboutBox.png");
